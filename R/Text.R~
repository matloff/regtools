...
### 1/1/2026: Removing these routines, due to discontinuation of the
### text2vec package. Several similar packages exist, but none with
### drop-in equivalence. Conversion would be a major project.
